 ...
 * This source code itself belongs to Stepps for Android v 1.0.
...
public class LoginActivity extends BaseFragment {
    ...
    public View createView(Context context, LayoutInflater inflater) {
        actionBar.setTitle(LocaleController.getString("app_name", R.string.app_name));
        ...
        menu.addItemWithWidth(done_button, R.mipmap.ic_done, AndroidUtilities.dp(56));
        ...
        for (int a = 0; a < views.length; a++) {
            ...
            if (currentViewNum == a) {
                actionBar.setBackButtonImage(views[a].needBackButton() ? R.mipmap.ic_ab_back : 0);
    ...
    public void setPage(int page, boolean animated, Bundle params, boolean back) {
        if (android.os.Build.VERSION.SDK_INT > 13) {
            ...
            currentViewNum = page;
            actionBar.setBackButtonImage(newView.needBackButton() ? R.mipmap.ic_ab_back : 0);
            ...
            actionBar.setBackButtonImage(views[page].needBackButton() ? R.mipmap.ic_ab_back : 0);
    ...
    public class PhoneView extends SlideView implements AdapterView.OnItemSelectedListener {
        ...
        public PhoneView(Context context) {
            ...
            LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) countryButton.getLayoutParams();
        ...
        public void onNextPressed() {
            ...
            if (countryState == 1) {
                needShowAlert(LocaleController.getString("app_name", R.string.app_name), LocaleController.getString("ChooseCountry", R.string.ChooseCountry));
                return;
            } else if (countryState == 2 && !BuildVars.DEBUG_VERSION) {
                needShowAlert(LocaleController.getString("app_name", R.string.app_name), LocaleController.getString("WrongCountry", R.string.WrongCountry));
                return;
            }
            if (codeField.length() == 0) {
                needShowAlert(LocaleController.getString("app_name", R.string.app_name), LocaleController.getString("InvalidPhoneNumber", R.string.InvalidPhoneNumber));
                return;
            }
                            ...
                            if (error == null) {
                                ...
                                if (error.text != null) {
                                    if (error.text.contains("PHONE_NUMBER_INVALID")) {
                                        ...
                                        needShowAlert(LocaleController.getString("app_name", R.string.app_name), LocaleController.getString("InvalidCode", R.string.InvalidCode));
                                    } else if (error.text.contains("PHONE_CODE_EXPIRED")) {
                                        needShowAlert(LocaleController.getString("app_name", R.string.app_name), LocaleController.getString("CodeExpired", R.string.CodeExpired));
                                    } else if (error.text.startsWith("FLOOD_WAIT")) {
                                        needShowAlert(LocaleController.getString("app_name", R.string.app_name), LocaleController.getString("FloodWait", R.string.FloodWait));
                                    } else if (error.code != -1000) {
                                        needShowAlert(LocaleController.getString("app_name", R.string.app_name), error.text);
                                    }
                                }
                            }
                            needHideProgress();
    ...
    public class LoginActivitySmsView extends SlideView implements NotificationCenter.NotificationCenterDelegate {
            ...
            problemText.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    try {
                        ...
                        needShowAlert(LocaleController.getString("app_name", R.string.app_name), LocaleController.getString("NoMailInstalled", R.string.NoMailInstalled));
                    }
                }
            });
        ...
        public void setParams(Bundle params) {
            ...
            try {
                ...
                TypefaceSpan span = new TypefaceSpan(AndroidUtilities.getTypeface(ApplicationLoader.applicationContext, "fonts/rmedium.ttf"));
                                    ...
                                    public void run() {
                                        ...
                                        if (error == null) {
                                            ...
                                            if (error.text.startsWith("FLOOD_WAIT")) {
                                                ...
                                                needShowAlert(LocaleController.getString("app_name", R.string.app_name), LocaleController.formatString("FloodWaitTime", R.string.FloodWaitTime, timeString));
                                            } else {
                                                needShowAlert(LocaleController.getString("app_name", R.string.app_name), error.text);
                                            }
                                        }
                        ...
                        public void run() {
                            ...
                            if (error == null) {
                                ...
                                if (error.text.contains("PHONE_NUMBER_INVALID")) {
                                    ...
                                    needShowAlert(LocaleController.getString("app_name", R.string.app_name), LocaleController.getString("InvalidFirstName", R.string.InvalidFirstName));
                                } else if (error.text.contains("LASTNAME_INVALID")) {
                                    needShowAlert(LocaleController.getString("app_name", R.string.app_name), LocaleController.getString("InvalidLastName", R.string.InvalidLastName));
                                } else {
                                    needShowAlert(LocaleController.getString("app_name", R.string.app_name), error.text);
                                }
                            }

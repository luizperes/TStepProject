...
public class CountrySelectActivity extends BaseFragment {
    ...
    public View createView(Context context, LayoutInflater inflater) {
        ...
        ActionBarMenuItem item = menu.addItem(0, R.mipmap.ic_ab_search).setIsSearchField(true).setActionBarMenuItemSearchListener(new ActionBarMenuItem.ActionBarMenuItemSearchListener() {
            @Override

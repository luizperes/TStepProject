...
public class DialogCell extends BaseCell {
    ...
    private void init() {
        if (namePaint == null) {
            ...
            checkDrawable = getResources().getDrawable(R.mipmap.dialogs_check);
            halfCheckDrawable = getResources().getDrawable(R.mipmap.dialogs_halfcheck);
            clockDrawable = getResources().getDrawable(R.mipmap.msg_clock);
            errorDrawable = getResources().getDrawable(R.mipmap.dialogs_warning);
            countDrawable = getResources().getDrawable(R.mipmap.dialogs_badge);
            groupDrawable = getResources().getDrawable(R.mipmap.list_group);
            broadcastDrawable = getResources().getDrawable(R.mipmap.list_broadcast);
            muteDrawable = getResources().getDrawable(R.mipmap.mute_grey);
        }
    }
                ...
                if (message.messageOwner instanceof TLRPC.TL_messageService) {
                    ...
                    if (chat != null && chat.id > 0) {
                        ...
                        if (message.messageOwner.media != null && !message.isMediaEmpty()) {
                            currentMessagePaint = messagePrintingPaint;
                            messageString = Emoji.replaceEmoji(AndroidUtilities.replaceTags(ApplicationLoader.applicationContext, String.format("<c#ff4d83b3>%s:</c> <c#ff4d83b3>%s</c>", name, message.messageText)), messagePaint.getFontMetricsInt(), AndroidUtilities.dp(20));
                        } else {
                            if (message.messageOwner.message != null) {
                                ...
                                mess = mess.replace("\n", " ");
                                messageString = Emoji.replaceEmoji(AndroidUtilities.replaceTags(ApplicationLoader.applicationContext, String.format("<c#ff4d83b3>%s:</c> <c#ff808080>%s</c>", name, mess.replace("<", "&lt;").replace(">", "&gt;"))), messagePaint.getFontMetricsInt(), AndroidUtilities.dp(20));
                            }
                        }
                    } else {
                        messageString = message.messageText;

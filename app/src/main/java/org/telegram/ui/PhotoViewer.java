...
public class PhotoViewer implements NotificationCenter.NotificationCenterDelegate, GestureDetector.OnGestureListener, GestureDetector.OnDoubleTapListener {
    ...
    public void setParentActivity(Activity activity) {
        ...
        if (progressDrawables == null) {
            ...
            progressDrawables[0] = parentActivity.getResources().getDrawable(R.mipmap.circle_big);
            progressDrawables[1] = parentActivity.getResources().getDrawable(R.mipmap.cancel_big);
            progressDrawables[2] = parentActivity.getResources().getDrawable(R.mipmap.load_big);
            progressDrawables[3] = parentActivity.getResources().getDrawable(R.mipmap.play_big);
        }
            ...
            public void onItemClick(int id) {
                if (id == -1) {
                   ...
                   if (opennedFromMedia) {
                       ...
                       // TODO: The code below was commented by Luiz and needs to be studied.
        ...
        menuItem = menu.addItem(0, R.mipmap.ic_ab_other);
        ...
        cropItem = menu.addItemWithWidth(gallery_menu_crop, R.mipmap.photo_crop, AndroidUtilities.dp(56));
        tuneItem = menu.addItemWithWidth(gallery_menu_tune, R.mipmap.tune, AndroidUtilities.dp(56));
        ...
        dateTextView.setTypeface(AndroidUtilities.getTypeface(ApplicationLoader.applicationContext, "fonts/rmedium.ttf"));
        ...
        checkImageView = new CheckBox(containerView.getContext(), R.mipmap.selectphoto_large);

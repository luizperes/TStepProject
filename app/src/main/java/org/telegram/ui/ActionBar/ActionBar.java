...
public class ActionBar extends FrameLayout {
    ...
    private void createTitleTextView() {
        ...
        titleTextView.setTypeface(AndroidUtilities.getTypeface(ApplicationLoader.applicationContext, "fonts/rmedium.ttf"));
    }
    ...
    public ActionBarMenu createActionMode() {
        ...
        actionMode.setBackgroundResource(R.mipmap.editheader);
        addView(actionMode);

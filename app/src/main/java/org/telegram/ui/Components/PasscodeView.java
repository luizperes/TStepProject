...
public class PasscodeView extends FrameLayout {
    ...
    public PasscodeView(final Context context) {
        ...
        imageView.setImageResource(R.mipmap.passcode_logo);
        ...
        checkImage.setImageResource(R.mipmap.passcode_check);
        ...
        eraseView.setImageResource(R.mipmap.passcode_delete);

...
public class PopupAudioView extends BaseCell implements SeekBar.SeekBarDelegate, MediaController.FileDownloadProgressListener {
    ...
    public PopupAudioView(Context context) {
        ...
        if (backgroundMediaDrawableIn == null) {
            ...
            statesDrawable[0][0] = getResources().getDrawable(R.mipmap.play1);
            statesDrawable[0][1] = getResources().getDrawable(R.mipmap.play1_pressed);
            statesDrawable[1][0] = getResources().getDrawable(R.mipmap.pause1);
            statesDrawable[1][1] = getResources().getDrawable(R.mipmap.pause1_pressed);
            statesDrawable[2][0] = getResources().getDrawable(R.mipmap.audioload1);
            statesDrawable[2][1] = getResources().getDrawable(R.mipmap.audioload1_pressed);
            statesDrawable[3][0] = getResources().getDrawable(R.mipmap.audiocancel1);
            statesDrawable[3][1] = getResources().getDrawable(R.mipmap.audiocancel1_pressed);

            statesDrawable[4][0] = getResources().getDrawable(R.mipmap.play2);
            statesDrawable[4][1] = getResources().getDrawable(R.mipmap.play2_pressed);
            statesDrawable[5][0] = getResources().getDrawable(R.mipmap.pause2);
            statesDrawable[5][1] = getResources().getDrawable(R.mipmap.pause2_pressed);
            statesDrawable[6][0] = getResources().getDrawable(R.mipmap.audioload2);
            statesDrawable[6][1] = getResources().getDrawable(R.mipmap.audioload2_pressed);
            statesDrawable[7][0] = getResources().getDrawable(R.mipmap.audiocancel2);
            statesDrawable[7][1] = getResources().getDrawable(R.mipmap.audiocancel2_pressed);

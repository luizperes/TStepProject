...
public class ApplicationLoader extends Application {
    ...
    public static int idWallpaper = 0;
    ...
    public static void reloadWallpaper() {
        ...
        if (ApplicationLoader.idWallpaper != 0)
            loadWallpaper(ApplicationLoader.idWallpaper);
        else
            FileLog.e("tmessages", "There is no wallpaper id to reload.");
    }

    public static void loadWallpaper(final int resIdBackground) {
        ApplicationLoader.idWallpaper = resIdBackground;
                    ...
                    try {
                        ...
                        if (selectedColor == 0) {
                            if (selectedBackground == 1000001) {
                                cachedWallpaper = applicationContext.getResources().getDrawable(resIdBackground);
                                isCustomTheme = false;
                            } else {
